...
// book modal is a popup component, on top of the main content
// stopPropagation(): prevent click event from reaching parent or child elements
  // ensure that only the only the <div> click event is handle
